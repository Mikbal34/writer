...
export default function PreviewPage() {
  ...
  return (
    <div className="flex flex-col lg:flex-row h-full">
      {/* Left: Chat */}
      <div className="lg:w-[40%] lg:min-w-[320px] lg:max-w-[500px] border-r border-sandy/40 flex flex-col h-full">
      ...
      <div className="flex-1 flex flex-col h-full min-w-0">
        {/* Tab bar */}
        <div className="px-4 py-2.5 border-b border-sandy/40 shrink-0 flex items-center">
